...
Currently, the most popular and reasonable way to pass credentials and secrets in a container is specifying them as **environment variables** at container runtime. You as a consumer of such an image don't expose any of your sensitive data publicly.
...
// Do we want to suggest https://www.vaultproject.io/intro/index.html ?
