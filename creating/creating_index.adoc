...
The profile section gives information about the rule file. This is the name identifier and description for the profile. This information should help users to identify and applicable template.
```
profile:
  name: "Default"
...
```
An excerpt from the rules show how includes are defined:
