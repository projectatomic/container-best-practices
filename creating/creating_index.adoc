...
Images that are meant to be run in OpenShift, should contain a set of recommended labels are seen in the https://docs.openshift.org/latest/creating_images/metadata.html[OpenShift Origin documentation]. The labels are namespaced in compliance with the https://docs.docker.com/engine/userguide/labels-custom-metadata/[Docker format]; that is _io.openshift_ for OpenShift and _io.k8s_ for Kubernetes.

For more details, refer to https://docs.openshift.org/latest/creating_images/metadata.html[https://docs.openshift.org/latest/creating_images/metadata.html].
