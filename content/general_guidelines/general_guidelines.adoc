...
// TBD - is this necessary? Something with secrets..
...
As an example of **yum clean** usage in a Dockerfile, see https://github.com/openshift/mysql/blob/master/5.5/Dockerfile[this] mysql Dockerfile.
